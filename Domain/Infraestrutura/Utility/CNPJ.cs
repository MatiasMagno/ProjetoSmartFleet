...
namespace SmartFleet.Domain.Infraestrutura.Utility
{
    class CNPJ
    {
        ...
        public static Boolean Validar(Int64 cnpj)
        {
            return Validar(cnpj.ToString("D14"));
        }
        ...
        public static Boolean Validar(string cnpj)
        {
            ...
            if (CalcularDigito(new_cnpj.Substring(0, 12)) == new_cnpj.Substring(12, 2))
            {
                return true;
            }
        ...
        public static string CalcularDigito(Int64 cnpj)
        {
            return CalcularDigito(cnpj.ToString("D12"));
        }
        ...
        /// <returns>string com o digito calculado do CNPJ ou null caso o CNPJ informado for maior que 12 digitos</returns>
        public static string CalcularDigito(string cnpj)
        {
            // Declara variaveis para uso
            string new_cnpj = "";
            string digito = "";
