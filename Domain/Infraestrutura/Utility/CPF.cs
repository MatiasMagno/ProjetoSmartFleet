 ...
 *  
 * public static Boolean Validar(cpf)
 ...
 *
 * public static string CalcularDigito(cpf)
...
namespace SmartFleet.Domain.Infraestrutura.Utility
{
    public static class CPF
    {
        ...
        public static Boolean Validar(Int64 cpf)
        {
            return Validar(cpf.ToString("D11"));
        }
        ...
        public static Boolean Validar(string cpf)
        {
            ...
            if (CalcularDigito(new_cpf.Substring(0, 9)) == new_cpf.Substring(9, 2))
            {
                return true;
            }
        ...
        public static string CalcularDigito(Int64 cpf)
        {
            return CalcularDigito(cpf.ToString("D9"));
        }
        ...
        /// <returns>string com o digito calculado do CPF ou null caso o cpf informado for maior que 9 digitos</returns>
        public static string CalcularDigito(string cpf)
        {
            // Declara variaveis para uso
            string new_cpf ="";
            string digito = "";
